...
public class ActivityNearBy extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                ...
                .build();
        setContentView(R.layout.activity_activity_near_by);
        ...
        pickerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    builder = new PlacePicker.IntentBuilder();
                    Intent intent = builder.build( ActivityNearBy.this);
                    // Start the Intent by requesting a result, identified by a request code.
                    startActivityForResult(intent, PLACE_PICKER_FLAG);

                } catch (GooglePlayServicesRepairableException e) {
                    GooglePlayServicesUtil
                            .getErrorDialog(e.getConnectionStatusCode(), ActivityNearBy.this, 0);
                } catch (GooglePlayServicesNotAvailableException e) {
                    Toast.makeText( ActivityNearBy.this, "Google Play Services is not available.",
                            Toast.LENGTH_LONG)
                            .show();
                }
            }
