...
public class Add_UserMoreDetails_doctor extends Activity {
    ...
    public void userReg(View view)
    {
        ...
        if(ischeck==true) {
            ...
            BackgroundTask4 backgroundTask = new BackgroundTask4(this);
            backgroundTask.execute(method, disease, Age, Status, Aname, Ayear, user_id, Atype,Aproblem,Sname,Syear,Stype,Sproblem,Mname,Mvalue);
            StartActivity();
            finish();
           }
    ...
    public void StartActivity(){
        ...
        Intent startIntent = new Intent(getApplicationContext(), PatientList.class);
