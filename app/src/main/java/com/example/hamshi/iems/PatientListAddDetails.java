 ...
 */
public class PatientListAddDetails extends Activity {
        ...
        list1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
               ...
               /* Intent startIntent = new Intent(getApplicationContext(), Patient.class);
                ...
                Intent intent = new Intent(getApplicationContext(), Add_UserMoreDetails.class);
    ...
    protected void showList(){
        try { session = new SessionManager(getApplicationContext());
            ...
            for(int i=0;i<peoples.length();i++){
                ...
                String C_id = c.getString(Cid);

                if (carer_id.equalsIgnoreCase(C_id) ) {
                    personList.add(name);
                    vId.add(id);
                    vName.add((name));
                }
    ...
    public void getData(){
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                HttpPost httppost = new HttpPost("http://192.168.1.9/listuser_forcarer2.php");
